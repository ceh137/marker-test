...
var common = {
    ...
    init: function() {
        ...
        add_event(document, 'click', function() {
            common.menu_popup_hide_all('inactive', event);
            common.results_hide('inactive', event);
        });
        add_event(document, 'scroll', function() {
            common.menu_popup_hide_all('all', event);
            common.results_hide('all', event);
        });
        common.scroll_fix();
    },
